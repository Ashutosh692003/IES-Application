...
public class pdfGenerator {
	...
	public boolean generateNoticePdf(HttpServletResponse resp,Integer caseNum,File f) throws Exception {
	    ...
	    // Loop through notices
	        ...
	        recipientInfo.add(new Phrase("\n Address: " + app.getHouseNum(), FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, bodyColor)));
	        ...
	        noticeBody.add(new Phrase("\n\n\n\n\nContact:dhsState@gmail.com ", FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, titleColor)));	        
	        noticeBody.add(new Phrase("\nWebsite :DHS/State.com", FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, nameColor)));	        
	        noticeBody.add(new Phrase("\nYear :2024", FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, nameColor)));	
	        noticeBody.add(new Phrase("\n\n Disclaimer : This notice is for informational purposes only", FontFactory.getFont(FontFactory.TIMES_ROMAN, 12, deniedColor)));	
